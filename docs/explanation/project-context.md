...
- `gomad-create-architecture` — respects technical preferences during solutioning
- `gomad-create-story` — informs story creation with project patterns
- `gomad-dev-story` — guides implementation decisions
- `gomad-code-review` — validates against project standards
- `gomad-quick-dev` — applies patterns when implementing specs
- `gomad-sprint-planning`, `gomad-retrospective`, `gomad-correct-course` — provides project-wide context
...
|----------|----------------|---------|
| **New project, before architecture** | Manually, before `gomad-create-architecture` | Document your technical preferences so the architect respects them |
| **New project, after architecture** | Via `gomad-generate-project-context` or manually | Capture architecture decisions for implementation agents |
| **Existing project** | Via `gomad-generate-project-context` | Discover existing patterns so agents follow established conventions |
| **Quick Flow project** | Before or during `gomad-quick-dev` | Ensure quick implementation respects your patterns |
...
Create the file at `_gomad-output/project-context.md` and add your rules:
...
Run the `gomad-generate-project-context` workflow after completing your architecture:
...
For existing projects, run `gomad-generate-project-context` to discover existing patterns:
...
You can edit it manually at any time, or re-run `gomad-generate-project-context` to update it after significant changes.

:::note[File Location]
The default location is `_gomad-output/project-context.md`. Workflows search for it there, and also check `**/project-context.md` anywhere in your project.
:::
