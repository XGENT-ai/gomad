...
/**
 * Load skill-manifest.yaml from a directory.
 ...
 * @param {string} dirPath - Directory to check for skill-manifest.yaml
...
async function loadSkillManifest(dirPath) {
  ...
  try {
    ...
    console.warn(`Warning: Failed to parse skill-manifest.yaml in ${dirPath}: ${error.message}`);
    return null;
  }
}
