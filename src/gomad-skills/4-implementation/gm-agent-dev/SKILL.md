...
| QA | Generate API and E2E tests for existing features | gomad-qa-generate-e2e-tests |
| CR | Initiate a comprehensive code review across multiple quality facets | gomad-code-review |
| SP | Generate or update the sprint plan that sequences tasks for implementation | gomad-sprint-planning |
| CS | Prepare a story with all required context for implementation | gomad-create-story |
| ER | Party mode review of all work completed across an epic | gomad-retrospective |
