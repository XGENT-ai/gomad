...
- Invoke the `gomad-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `gomad-party-mode` skill with the current inspiration analysis
