...
- Invoke the `gomad-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `gomad-party-mode` skill with the current responsive/accessibility strategy
