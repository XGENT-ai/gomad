...
- Invoke the `gomad-advanced-elicitation` skill with the current design system content
...
- Invoke the `gomad-party-mode` skill with the current design system choice
