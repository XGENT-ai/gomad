...
- Invoke the `gomad-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `gomad-party-mode` skill with the current visual foundation
