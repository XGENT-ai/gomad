...
- Invoke the `gomad-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `gomad-party-mode` skill with the current emotional response definition
