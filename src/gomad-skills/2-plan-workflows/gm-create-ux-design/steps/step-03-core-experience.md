...
- Invoke the `gomad-advanced-elicitation` skill with the current core experience content
...
- Invoke the `gomad-party-mode` skill with the current core experience definition
