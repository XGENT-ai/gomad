...
- Invoke the `gomad-advanced-elicitation` skill with the current design direction content
...
- Invoke the `gomad-party-mode` skill with the current design direction
