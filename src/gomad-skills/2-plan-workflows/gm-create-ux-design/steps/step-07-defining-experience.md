...
- Invoke the `gomad-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `gomad-party-mode` skill with the current defining experience
