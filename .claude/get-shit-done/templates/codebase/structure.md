...
- Usage: Reference from command with `@/Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/rockie/Documents/GitHub/xgent/gomad/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/rockie/Documents/GitHub/xgent/gomad/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
