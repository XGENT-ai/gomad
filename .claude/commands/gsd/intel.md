...
Intel system is disabled. To activate:
  ...
  node /Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/rockie/Documents/GitHub/xgent/gomad/.claude/get-shit-done/bin/gsd-tools.cjs
