 ...
 *
 * Transforms:
 *   /img/foo.png → /GOMAD-METHOD/img/foo.png (when base is /GOMAD-METHOD/)
 *   /llms.txt → /GOMAD-METHOD/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/GOMAD-METHOD/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /GOMAD-METHOD/img/foo.png.
